...
export default function StoriesCampaignsRoute() {
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-4">Stories & Campaigns</h1>
        <p className="text-slate-400">Brand stories and campaign content.</p>
